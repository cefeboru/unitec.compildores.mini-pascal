...
class LexerBackup {
  ...
  private static final String ZZ_ROWMAP_PACKED_0 =
    "\0\0\0\13\0\26\0\41\0\13\0\54\0\67\0\102"+
  ...
  private static final String ZZ_TRANS_PACKED_0 =
    "\1\2\1\3\2\2\1\4\5\2\1\5\15\0\1\2"+
    "\16\0\1\6\13\0\1\7\11\0\1\10\14\0\1\11"+
    "\13\0\1\12\6\0\1\13\6\0\3\13\1\14\1\0"+
    "\4\13\7\0\1\15\13\0\1\16\11\0\1\17\14\0"+
    "\1\20\13\0\1\21\6\0\1\22\5\0";
  ...
  public static void main(String argv[]) {
    if (argv.length == 0) {
      ...
      for (int i = firstFilePos; i < argv.length; i++) {
        LexerBackup scanner = null;
        try {
          java.io.FileInputStream stream = new java.io.FileInputStream(argv[i]);
          java.io.Reader reader = new java.io.InputStreamReader(stream, encodingName);
          scanner = new LexerBackup(reader);
